...
# --- Match the imports from your working Eyes Detection code ---
...
def main():
    ...
    while True:
        print("\n--- HCI Detection System Menu ---")
        print("1. Live Webcam | 2. Video | 3. Image | 0. Exit")
        ...
        print("\n--- Select Module ---")
        print("1. Lips Detection | 0. Back")
        m = input("Select Mode: ")
        if m == "1":
            if is_image:
                module1_lips_detection_image(source)
            else:
                module1_lips_detection(source)
